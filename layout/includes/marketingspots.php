 ...
 * @return string
 */
function university_marketingspot() {
    ...
    for ($i = 1; $i <= 4; $i++) {
        $mspicon = theme_university_get_setting('mspot'.$i.'icon');
        $msptitle = theme_university_get_setting('mspot'.$i.'title');
        $mspdescription = theme_university_get_setting('mspot'.$i.'desc');
    ...
    for ($i = 1; $i <= 4; $i++) {
        $mspicon = theme_university_get_setting('mspot'.$i.'icon');
        $msptitle = theme_university_get_setting('mspot'.$i.'title');
        $msptitle = theme_university_lang($msptitle);
        $mspdescription = theme_university_get_setting('mspot'.$i.'desc');
        $mspdescription = theme_university_lang($mspdescription);
