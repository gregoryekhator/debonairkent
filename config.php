...
$THEME->sheets = ['university', 'custom', 'slick'];
...
$THEME->csstreepostprocessor = 'theme_university_css_tree_post_processor';
...
$no = get_config('theme_university', 'patternselect'); // Selected theme pattern no returned.
...
$THEME->csspostprocess = 'theme_university_process_css';
